...
#define TIM_SlaveMode_EncoderMode1         ((uint16_t)0x0001)	// Encoder mode 1 - Counter counts up/down on TI2FP1 edge depending on TI1FP2 level.
#define TIM_SlaveMode_EncoderMode2         ((uint16_t)0x0002)	// Encoder mode 2 - Counter counts up/down on TI1FP2 edge depending on TI2FP1 level.
#define TIM_SlaveMode_EncoderMode3         ((uint16_t)0x0003)	// Encoder mode 3 - Counter counts up/down on both TI1FP1 and TI2FP2 edges depending on the level of the other input.
